...
femaleAll$qval_status <- qvalue(femaleAll$pval_status)$qvalue

sigInAllGeneList <- rownames(femaleAll)[femaleAll$qval_status < .0736]
...
femaleLPS$sigInAll <- rownames(femaleLPS) %in% sigInAllGeneList
#femaleLPS$qval_treatment <- qvalue(femaleLPS$pval_treatment)$qvalue
...
#femaleGard$qval_treatment <- qvalue(femaleGard$pval_treatment)$qvalue
femaleGard$sigInAll <- rownames(femaleGard) %in% sigInAllGeneList
...
#femaleDex$qval_treatment <- qvalue(femaleDex$pval_treatment)$qvalue
femaleDex$sigInAll <- rownames(femaleDex) %in% sigInAllGeneList
...
#femaleDex$qval_treatment <- qvalue(femaleDex$pval_treatment)$qvalue
femaleCtrl$sigInAll <- rownames(femaleCtrl) %in% sigInAllGeneList
...
ggplot(data = fAllCtrlPlot,
  ...
  scale_y_continuous(name="Ctrl Condition", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5)) +
  geom_point(size = pointSize, col = "gray15", 
             aes(shape = fdr_status < .1)) +
  scale_shape_manual(values = c(1,4)) +
  theme(legend.position = "none")
ggsave(paste0(figPaperDir,"3a_CtrlVallTrt_sigBetaPlot_xShapeAllSig.png"), width = 4, height = 4)
...
ggplot(data = fAllCtrlPlot,
  ...
  scale_y_continuous(name="Ctrl Condition", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5)) +
  geom_point(size = pointSize, col = "gray15", 
             aes(shape = fdr_status < .001)) +
  scale_shape_manual(values = c(1,4)) +
  theme(legend.position = "none")
ggsave(paste0(figPaperDir,"3a_CtrlVallTrt_sigBetaPlot_xShapeUniqueSig.png"), width = 4, height = 4)
...
fAllGardPlot$pointShape <- ifelse(fAllGardPlot$fdr_status < .1 & !fAllGardPlot$sigInAll, TRUE, FALSE)
...
ggplot(data = fAllGardPlot,
  ...
  scale_x_continuous(name="All Treatment", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5)) +
  scale_y_continuous(name="Gard Condition", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5), position = "right") +
  geom_point(size = pointSize, col = gardF, aes(shape = fdr_status < .1)) +
   scale_shape_manual(values = c(1,4)) +
  theme(legend.position = "none")
ggsave(paste0(figPaperDir,"3a_GardVallTrt_sigBetaPlot_xShapeAll__RIGHT.png"), width = 4, height = 4)
...
ggplot(data = fAllGardPlot,
  ...
  scale_x_continuous(name="All Treatment", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5)) +
  scale_y_continuous(name="Gard Condition", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5), position = "right") +
  geom_point(size = pointSize, col = gardF, aes(shape = pointShape)) +
  scale_shape_manual(values = c(1,4)) +
  theme(legend.position = "none")
ggsave(paste0(figPaperDir,"3a_GardVallTrt_sigBetaPlot_xShapeUnique__RIGHT.png"), width = 4, height = 4)
...
fAllLPSPlot$pointShape <- ifelse(fAllLPSPlot$fdr_status < .1 & !fAllLPSPlot$sigInAll, TRUE, FALSE)
...
ggplot(data = fAllLPSPlot,
  ...
  scale_color_manual(values = c(lpsF,"gray15")) +
  scale_shape_manual(values = c(1,4))
ggsave(paste0(figPaperDir,"3a_lpsVallTrt_sigBetaPlot_xShapeAllSig.png"), width = 4, height = 4)
...
ggplot(data = fAllLPSPlot,
  ...
  scale_y_continuous(name="LPS Condition", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5)) +
  geom_point(size = pointSize, 
             aes(shape = pointShape)) +
  theme(legend.position = "none") +
  scale_color_manual(values = c(lpsF,"gray15")) +
  scale_shape_manual(values = c(1,4))
ggsave(paste0(figPaperDir,"3a_lpsVallTrt_sigBetaPlot_xShapeUniqueSig.png"), width = 4, height = 4)
...
### ONLY identified in the given condition -- X
### identified in either all treatments only, or all treatments and the given condition -- O
...
ggplot(data = fAllDexPlot,
  ...
  scale_x_continuous(name="All Treatment", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5)) +
  scale_y_continuous(name="Dex Condition", limits=c(-7.5, 7.5), breaks=c(-5,-2.5,0,2.5,5), position = "right") +
  geom_point(size = pointSize, col = dexF, aes(shape = fdr_status < .1)) +
  scale_shape_manual(values = c(1,4)) +
  theme(legend.position = "none")
ggsave(paste0(figPaperDir,"3a_DexVallTrt_sigBetaPlot_xShape__RIGHT.png"), width = 4, height = 4)
```
